...
class DailyCashbookReport(models.TransientModel):
    ...
    end_date = fields.Date(string="End Date",
                                required=True)
    company_id = fields.Many2many("res.company",required=True)
    entry_type = fields.Selection([('draft','Draft Entries'),('posted','Posted Entries'),('all','All Entries')],default='all')
    report_type = fields.Selection([('frame','Frame'),('coa','Chart of Account'),('group','Group Types')],default='coa')
