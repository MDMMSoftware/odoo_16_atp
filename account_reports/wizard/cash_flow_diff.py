...
class CashFlowDiff(models.TransientModel):
    ...
    def export_cash_flow(self):
        ...
        sheet.write(11,0,(_("Depreciation")),text_format)
        ...
        sheet.write(19,0,(_("Changes in  Prepayment Expenses")),text_format)
        sheet.write(20,0,(_("Changes in  Advance Tax")),text_format)
        sheet.write(21,0,(_("Changes in  Accrued Expenses")),text_format)
        sheet.write(22,0,(_("Provision for Tax")),text_format)
        sheet.write(23,0,(_("Cash Flow from Operating Activities")),bold_text_format)
        sheet.write(25,0,(_("Investing Activites")),header_text_format)
        sheet.write(26,0,(_("Non Current Assets")),text_format)
        sheet.write(27,0,(_("Intangible Assets")),text_format)
        sheet.write(28,0,(_("Cash Flow from Investing Activities")),bold_text_format)
        sheet.write(30,0,(_("Financing Activites")),header_text_format)
        sheet.write(31,0,(_("Changes in Equity")),text_format)
        sheet.write(32,0,(_("Bank Loan")),text_format)
        sheet.write(33,0,(_("Other Loan")),text_format)
        sheet.write(34,0,(_("Cash Flow from Financing Activities")),bold_text_format)
        sheet.write(36,0,(_("Net Changes in Cash and Cash Equivalent during the year")),bold_text_format)
        sheet.write(37,0,(_("Cash Balance at the beginning of the year")),text_format)
        sheet.write(38,0,(_("Adjustment for Opening Retained Earning")),bold_text_format)
        sheet.write(39,0,(_("Cash Balance at the end of of the year")),bold_text_format)
        ...
        while date_start<=t_date_start:
            ...
            depreciation = self.generate_deb_credit('Depreciation',date_start,date_end,self.entry_options)
            ...
            change_prepayment = (self.generate_deb_credit('Changes in  Prepayment Expenses',b_date_start,b_date_end,self.entry_options)-self.generate_deb_credit('Changes in  Prepayment Expenses',date_start,date_end,self.entry_options))
            change_advance = (self.generate_deb_credit('Changes in  Advance Tax',b_date_start,b_date_end,self.entry_options)-self.generate_deb_credit('Changes in  Advance Tax',date_start,date_end,self.entry_options))
            change_accured = (self.generate_deb_credit('Changes in  Accrued Expenses',b_date_start,b_date_end,self.entry_options)-self.generate_deb_credit('Changes in  Accrued Expenses',date_start,date_end,self.entry_options))
            change_tax = (self.generate_deb_credit('Provision for Tax',b_date_start,b_date_end,self.entry_options)-self.generate_deb_credit('Provision for Tax',date_start,date_end,self.entry_options))
            opearting_activities += depreciation+amortisation+change_inv+change_recei+change_pay+change_lib+change_tax+change_prepayment+change_advance+change_accured
            ...
            sheet.write(19,1+i,change_prepayment or '-',text_format)
            sheet.write(20,1+i,change_advance or '-',text_format)
            sheet.write(21,1+i,change_accured or '-',text_format)
            sheet.write(22,1+i,change_tax or '-',text_format)
            sheet.write(23,1+i,opearting_activities or '-',text_format)
            ...
            sheet.write(26,1+i,non_current_asset or '-',text_format)
            sheet.write(27,1+i,intangible_asset or '-',text_format)
            sheet.write(28,1+i,investing_activities or '-',text_format)
            share_capital = self.generate_cre_debit('Changes in Equity',date_start,date_end,self.entry_options)
            bank_loan = self.generate_cre_debit('Bank Loan',date_start,date_end,self.entry_options)
            other_loan = self.generate_cre_debit('Other Loan',date_start,date_end,self.entry_options)
            financing_activities += share_capital+bank_loan+other_loan
            sheet.write(31,1+i,share_capital or '-',text_format)
            sheet.write(32,1+i,bank_loan or '-',text_format)
            sheet.write(33,1+i,other_loan or '-',text_format)
            sheet.write(34,1+i,financing_activities or '-',text_format)
            net_change = 0
            net_change += opearting_activities+investing_activities+financing_activities
            sheet.write(36,1+i,net_change or '-',text_format)
            sheet.write(37,1+i,cash_balance or '-',text_format)
            retain_earning = self.generate_deb_credit('Adjustment for Opening Retained Earning',date_start,date_end,self.entry_options)
            sheet.write(38,1+i,retain_earning or '-',text_format)
            cash_end_balance = retain_earning+cash_balance+net_change
            cash_balance = cash_end_balance
            sheet.write(39,1+i,cash_end_balance or '-',text_format)
            i+=1
