            ...
            if col_value is None:
                ...
                if col_expr_label == 'date_maturity':
                    ...
                    if col_expr_label == 'ref':
                        ...
                        col_class = ''
                    if col_expr_label == 'name':
                        col_class = 'o_account_report_name_ellipsis_partner_ledger_customize'
                    elif col_expr_label == 'matching_number':
                        col_class = 'o_account_report_name_ellipsis_partner_ledger_customize_matching_number'
