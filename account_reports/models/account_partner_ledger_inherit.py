...
class PartnerLedgerCustomHandlerInherit(models.AbstractModel):
    _name = 'account.partner.ledger.report.handler.inherit'
    _inherit = 'account.report.custom.handler'
    _description = 'Partner Ledger Custom Handler Inherit'
    ...
    def _custom_unfold_all_batch_data_generator(self, report, options, lines_to_expand_by_function):
        ...
        # Regular case
        for line_dict in lines_to_expand_by_function.get('_report_expand_unfoldable_line_partner_ledger_inherit', []):
    ...
    def _get_query_sums(self, options):
        ...
        params = []
        queries = []
        report = self.env.ref('account_reports.partner_ledger_report_inherit')
    ...
    def _report_expand_unfoldable_line_partner_ledger_inherit(self, line_dict_id, groupby, options, progress, offset, unfold_all_batch_data=None):
    ...
    def _get_report_line_partners(self, options, partner, partner_values, level_shift=0):
        ...
        return {
            ...
            'expand_function': '_report_expand_unfoldable_line_partner_ledger_inherit',
        }
