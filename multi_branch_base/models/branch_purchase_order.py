...
#                     ('company_id','=',self.env.company.id)])
    ...
    def _get_picking_type(self, company_id):
        ...
        if len(self.env.user.branch_ids) == 1:
            ...
            # if not picking_type:
            #     branch_ids = self.env['res.branch'].search([('id','in',self.env.user.branch_ids.ids),('company_id','=',self.env.user.company_id.id)])
    ...
    def onchange_branch_id(self):
        ...
        if self.branch_id:
            ...
            #     self.pricelist_id = self.env.user.pricelist_id          
        return {"domain" : {"picking_type_id" : ['&',('branch_id','=',self.branch_id.id),('code','=','incoming'), '|', ('warehouse_id', '=', False), ('warehouse_id.company_id', '=', self.company_id.id)]}}
