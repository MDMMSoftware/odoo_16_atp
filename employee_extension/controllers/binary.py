...
class EmployeeBinary(http.Controller):
        
        @http.route(['/hrapp/image/<string:model>/<int:id>/<string:field>'], type='http', auth='user', website='True')
        def content_hrapp_image(self, xmlid=None, model='ir.attachment', id=None, field='raw',
